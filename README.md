# VProxies for Windows — Fluent desktop 1.0.2
...
- Version 1.0.2 connects the device directly to the selected source proxy. It never falls back to the old Gateway relay endpoint.
- VProxies checks the latest public GitHub Release at startup and when the version badge is clicked. Updates are installed only after user confirmation and SHA-256 verification.
